...
// CompanySubscriptionRepository (na criação otimista da assinatura e no
// cancelamento) sem depender do SubscriptionModule inteiro (que por sua vez
// depende de CompanyModule), evitando import circular entre os dois.
@Module({
