import { RecipeValidator, RecipeRules } from './recipe-validator';

describe('RecipeValidator unit tests', () => {
  ...
  it('should pass validation with valid data', () => {
    ...
    expect(validator.validatedData).toBeInstanceOf(RecipeRules);
  });
});
