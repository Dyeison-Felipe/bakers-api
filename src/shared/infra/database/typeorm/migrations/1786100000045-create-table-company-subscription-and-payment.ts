...
export class CreateTableCompanySubscriptionAndPayment1786100000045
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'stripe_subscription_id', type: 'varchar', isNullable: false },
    ...
    // Protege findByStripeSubscriptionId de nunca casar duas empresas com o
    // mesmo id de subscription do Stripe.
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_company_subscription_stripe_subscription_id" ON "company_subscription" ("stripe_subscription_id") WHERE "deleted_at" IS NULL`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "uq_company_subscription_stripe_subscription_id"`,
    );
